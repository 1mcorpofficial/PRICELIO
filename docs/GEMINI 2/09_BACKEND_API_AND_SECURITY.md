# CHEST 9: Backend API Gateway & Security

## 1. APŽVALGA IR TIKSLAI (OVERVIEW & GOALS)
Masyvi skrynia apie serverio pusę. Node.js Express maršrutai, Rate-Limiting, saugumo praktikos, integracijos su duomenų baze ir visi API endpoints.
...
### Failas: `services/api/src/index.js`
**Eilučių skaičius:** 2964
...
*Failo statistika: Įtraukta esminių failų (1). Bendras kodo eilučių skaičius šioje skrynioje: ~2964.*
