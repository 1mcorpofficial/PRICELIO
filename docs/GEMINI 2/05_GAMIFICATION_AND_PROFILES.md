# CHEST 5: Gamification, Profiles & Kids Space

## 1. APŽVALGA IR TIKSLAI (OVERVIEW & GOALS)
Ši skrynia atidaro žaidybinimo (Gamification) mechaniką. Profilio ekranas su XP progresu, 'Top Hoarders' vs 'Top Whales' lyderių lentelės, ir unikali Vaikų Erdvė (Kids Space) su animuotais apdovanojimais.
...
### Failas: `apps/mobile/lib/features/profile/presentation/profile_page.dart`
**Eilučių skaičius:** 328
...
### Failas: `apps/mobile/lib/features/kids/presentation/kids_page.dart`
**Eilučių skaičius:** 439
**Paskirtis:** Sistemos logika, UI išdėstymas ir konfigūracija.
...
*Failo statistika: Įtraukta esminių failų (2). Bendras kodo eilučių skaičius šioje skrynioje: ~767.*
